...
const defaultPackages: Package[] = [
  { id: 1, name: 'Basic Strip (3 Foto)', price: 25000, photos_count: 3, duration: 5, description: 'Format strip klasik 3 foto' },
  { id: 2, name: 'Standard Strip (4 Foto)', price: 35000, photos_count: 4, duration: 5, description: 'Format strip populer 4 foto' },
  { id: 3, name: 'Grid Double (6 Foto)', price: 45000, photos_count: 6, duration: 10, description: 'Format grid 6 foto seru' },
  { id: 4, name: 'Unlimited Pass', price: 60000, photos_count: 8, duration: 15, description: 'Format penuh 8 foto lengkap' }
];
